...
const { Page_1, Page_2, Page_3 } = require("../../../../../settings/Item_class/sword/sword_warrior_item.js");

const selectSword_warrior = async (client, interaction, msg, item) => {
    ...
    const row1 = new ActionRowBuilder()
        .addComponents([
            new StringSelectMenuBuilder()
                .setCustomId("sword_shop_warrior_1")
        ...
        .addComponents([    
            new StringSelectMenuBuilder()   
                .setCustomId("sword_shop_warrior_2")
                .setPlaceholder(`Please selection item to buy.`)    
                .setMaxValues(1)    
                .setMinValues(1)    
                /// Map the categories to the select menu   
        ...
        .addComponents([    
            new StringSelectMenuBuilder()   
                .setCustomId("sword_shop_warrior_3")
                .setPlaceholder(`Please selection item to buy.`)    
                .setMaxValues(1)
                .setMinValues(1)
                /// Map the categories to the select menu   
  ...
  pages.push({
    ...
    collector.on('collect', async (menu) => {
        if(menu.isSelectMenu()) {
            if(menu.customId === "sword_shop_warrior_1") {
                ...
                iteminv.item.push({
                    ...
                    status: item.status,
                    type: item.type,
                    damage_attack: item.damage_attack,
            ...
            } else if(menu.customId === "sword_shop_warrior_2") {
                await menu.deferUpdate();
                let [ directory ] = menu.values;
                ...
                await menu.followUp({ embeds: [embed], components: [], files: [] });
            } else if(menu.customId === "sword_shop_warrior_3") {
                await menu.deferUpdate();
                let [ directory ] = menu.values;
...
module.exports = { selectSword_warrior };