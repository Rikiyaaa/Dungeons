...
const food_feed = async (client, interaction, msg, item) => {
    ...
    const inv = await GInv.findOne({ guild: interaction.guild.id, user: interaction.user.id });
        ...
        if(object.length === 0) {
            const embed = new EmbedBuilder()
                ...
                .setDescription("You don't have any food.")
        ...
        const select = new ActionRowBuilder()
            .addComponents([
                new StringSelectMenuBuilder()
                    ...
                    .setPlaceholder("Select a food to feed.")
                    .setMaxValues(1)
                    .setMinValues(1)
