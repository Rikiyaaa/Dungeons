...
const { Page_1, Page_2, Page_3 } = require("../../../../../settings/Item_class/armor_foot/armor_foot_sword_item.js");

const selectArmor_foot_sword = async (client, interaction, msg, item) => {
    ...
    const row1 = new ActionRowBuilder()
        .addComponents([
            new StringSelectMenuBuilder()
                .setCustomId("armor_foot_shop_sword_1")
        ...
        .addComponents([    
            new StringSelectMenuBuilder()   
                .setCustomId("armor_foot_shop_sword_2")
                .setPlaceholder(`Please selection item to buy.`)    
                .setMaxValues(1)    
                .setMinValues(1)    
                /// Map the categories to the select menu   
        ...
        .addComponents([    
            new StringSelectMenuBuilder()   
                .setCustomId("armor_foot_shop_sword_3")
                .setPlaceholder(`Please selection item to buy.`)    
                .setMaxValues(1)
                .setMinValues(1)
                /// Map the categories to the select menu   
  ...
  pages.push({
    ...
    collector.on('collect', async (menu) => {
        if(menu.isSelectMenu()) {
            if(menu.customId === "armor_foot_shop_sword_1") {
            ...
            } else if(menu.customId === "armor_foot_shop_sword_2") {
                await menu.deferUpdate();
                let [ directory ] = menu.values;
               ...
               iteminv.item.push({
                ...
                await menu.followUp({ embeds: [embed], components: [], files: [] });
            } else if(menu.customId === "armor_foot_shop_sword_3") {
                await menu.deferUpdate();
                let [ directory ] = menu.values;
...
module.exports = { selectArmor_foot_sword };