...
const editFurnitureA = async function (client, interaction,  item, type, id, side) {
    ...
    await interaction.editReply({ embeds: [embed], components: [select, button], files: [attc], ephemeral: true });
        ...
        if(menu.isStringSelectMenu()) {
            ...
            if(menu.customId === "furplace_a") {
                ...
                if (directory === "place_aone") {
                    ...
                    await interaction.editReply({ embeds: [], components: [], files: [build], ephemeral: true }).then(async (message) => {
                        await saveA1(interaction, id,  message, check);
                    });
                    collector.stop();
                    ...
                    await interaction.editReply({ embeds: [], components: [], files: [build], ephemeral: true }).then(async (message) => {
                        await saveA2(interaction, id,  message, check);
                    });
                    collector.stop();
                    ...
                    await interaction.editReply({ embeds: [], components: [], files: [build], ephemeral: true }).then(async (message) => {
                        await saveA3(interaction, id,  message, check);
                    });
                    collector.stop();
                    ...
                    await interaction.editReply({ embeds: [], components: [], files: [build], ephemeral: true }).then(async (message) => {
                        await saveA4(interaction, id,  message, check);
                    });
                    collector.stop();
                }
            }
            ...
            if(menu.customId === "a_one") {
              //
                ...
                editFurnitureB(client, interaction,  item, type, id);
                collector.stop();
            } else if (menu.customId === "c_three") {
                editFurnitureC(client, interaction,  item, type, id);
                collector.stop();
            } else if (menu.customId === "d_four") {
                editFurnitureD(client, interaction,  item, type, id);
                collector.stop();
            }
        }
    });
...
const editFurnitureB = async function (client, interaction,  item, type, id) {
    if (!interaction && !interaction.channel) throw new Error('Channel is inaccessible.');
        ...
        if(menu.isStringSelectMenu()) {
            ...
            if(menu.customId === "furplace_b") {
                ...
                if (directory === "place_bone") {
                    ...
                    await interaction.editReply({ embeds: [], components: [], files: [build], ephemeral: true }).then(async (message) => {
                        await saveB1(interaction, id,  message, check);
                    });
                    collector.stop();
                    ...
                    await interaction.editReply({ embeds: [], components: [], files: [build], ephemeral: true }).then(async (message) => {
                        await saveB2(interaction, id,  message, check);
                    });
                    collector.stop();
                    ...
                    await interaction.editReply({ embeds: [], components: [], files: [build], ephemeral: true }).then(async (message) => {
                        await saveB3(interaction, id,  message, check);
                    });
                    collector.stop();
                    ...
                    await interaction.editReply({ embeds: [], components: [], files: [build], ephemeral: true }).then(async (message) => {
                        await saveB4(interaction, id,  message, check);
                    });
                    collector.stop();
                }
            }
            ...
            await menu.deferUpdate();
            if(menu.customId === "a_one") {
                editFurnitureA(client, interaction,  item, type, id);
                collector.stop();
            } else if (menu.customId === "b_two") {
                //
            } else if (menu.customId === "c_three") {
...
const editFurnitureC = async function (client, interaction,  item, type, id) {
    if (!interaction && !interaction.channel) throw new Error('Channel is inaccessible.');
        ...
        if(menu.isStringSelectMenu()) {
            ...
            if(menu.customId === "furplace_c") {
                ...
                if (directory === "place_cone") {
                    ...
                    await interaction.editReply({ embeds: [], components: [], files: [build], ephemeral: true }).then(async (message) => {
                        await saveC1(interaction, id,  message, check);
                    });
                    collector.stop();
                    ...
                    await interaction.editReply({ embeds: [], components: [], files: [build], ephemeral: true }).then(async (message) => {
                        await saveC2(interaction, id,  message, check);
                    });
                    collector.stop();
                    ...
                    await interaction.editReply({ embeds: [], components: [], files: [build], ephemeral: true }).then(async (message) => {
                        await saveC3(interaction, id,  message, check);
                    });
                    collector.stop();
                    ...
                    await interaction.editReply({ embeds: [], components: [], files: [build], ephemeral: true }).then(async (message) => {
                        await saveC4(interaction, id,  message, check);
                    });
                    collector.stop();
                }
            }
...
const editFurnitureD = async function (client, interaction,  item, type, id) {
    if (!interaction && !interaction.channel) throw new Error('Channel is inaccessible.');
        ...
        if(menu.isStringSelectMenu()) {
            ...
            if(menu.customId === "furplace_d") {
                ...
                if (directory === "place_done") {
                    ...
                    await interaction.editReply({ embeds: [], components: [], files: [build], ephemeral: true }).then(async (message) => {
                        await saveD1(interaction, id,  message, check);
                    });
                    collector.stop();
                    ...
                    await interaction.editReply({ embeds: [], components: [], files: [build], ephemeral: true }).then(async (message) => {
                        await saveD2(interaction, id,  message, check);
                    });
                    collector.stop();
                    ...
                    await interaction.editReply({ embeds: [], components: [], files: [build], ephemeral: true }).then(async (message) => {
                        await saveD3(interaction, id,  message, check);
                    });
                    collector.stop();
                    ...
                    await interaction.editReply({ embeds: [], components: [], files: [build], ephemeral: true }).then(async (message) => {
                        await saveD4(interaction, id,  message, check);
                    });
                    collector.stop();
                }
            }
