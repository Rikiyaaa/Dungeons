...
const { Page_1, Page_2, Page_3 } = require("../../../../../settings/Item_class/armor_body/armor_body_magic_item.js");

const selectArmor_body_magic = async (client, interaction, msg, item) => {
    ...
    const row1 = new ActionRowBuilder()
        .addComponents([
            new StringSelectMenuBuilder()
                .setCustomId("armor_body_shop_magic_1")
        ...
        .addComponents([    
            new StringSelectMenuBuilder()   
                .setCustomId("armor_body_shop_magic_2")
                .setPlaceholder(`Please selection item to buy.`)    
                .setMaxValues(1)    
                .setMinValues(1)    
                /// Map the categories to the select menu   
        ...
        .addComponents([    
            new StringSelectMenuBuilder()   
                .setCustomId("armor_body_shop_magic_3")
                .setPlaceholder(`Please selection item to buy.`)    
                .setMaxValues(1)
                .setMinValues(1)
                /// Map the categories to the select menu   
  ...
  pages.push({
    ...
    collector.on('collect', async (menu) => {
        if(menu.isSelectMenu()) {
            if(menu.customId === "armor_body_shop_magic_1") {
            ...
            } else if(menu.customId === "armor_body_shop_magic_2") {
                await menu.deferUpdate();
                let [ directory ] = menu.values;
                ...
                await menu.followUp({ embeds: [embed], components: [], files: [] });
            } else if(menu.customId === "armor_body_shop_magic_3") {
                await menu.deferUpdate();
                let [ directory ] = menu.values;
...
module.exports = { selectArmor_body_magic };