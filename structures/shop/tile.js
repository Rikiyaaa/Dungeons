...
const { Page_1, Page_2, Page_3, Page_4, Page_5, Page_6, Page_7, Page_8, Page_9, Page_10, 
        Page_11, Page_12, Page_13, Page_14, Page_15, Page_16, Page_17, Page_18} = require("../../settings/Item_shop/tile.js");
      ...
      pages.push({
        ...
        collector.on('collect', async (menu) => {
            if(menu.isSelectMenu()) {
                if(menu.customId === "shop_tile_1") {
                ...
                } else if(menu.customId === "shop_tile_2") {
                    await menu.deferUpdate();
                    let [ directory ] = menu.values;
                    ...
                    await collector.stop();
                    await menu.followUp({ embeds: [embed], components: [], files: [] })
                } else if(menu.customId === "shop_tile_3") {
                    await menu.deferUpdate();
                    let [ directory ] = menu.values;
                    ...
                    await collector.stop();
                    await menu.followUp({ embeds: [embed], components: [], files: [] })
                } else if(menu.customId === "shop_tile_4") {
                    await menu.deferUpdate();
                    let [ directory ] = menu.values;
                    ...
                    await collector.stop();
                    await menu.followUp({ embeds: [embed], components: [], files: [] })
                }  else if(menu.customId === "shop_tile_5") {
                    await menu.deferUpdate();
                    let [ directory ] = menu.values;
                    ...
                    await collector.stop();
                    await menu.followUp({ embeds: [embed], components: [], files: [] })
                } else if(menu.customId === "shop_tile_6") {
                    await menu.deferUpdate();
                    let [ directory ] = menu.values;
                    ...
                    await collector.stop();
                    await menu.followUp({ embeds: [embed], components: [], files: [] })
                } else if(menu.customId === "shop_tile_7") {
                    await menu.deferUpdate();
                    let [ directory ] = menu.values;
                    ...
                    await collector.stop();
                    await menu.followUp({ embeds: [embed], components: [], files: [] })
                } else if(menu.customId === "shop_tile_8") {
                    await menu.deferUpdate();
                    let [ directory ] = menu.values;
                    ...
                    await collector.stop();
                    await menu.followUp({ embeds: [embed], components: [], files: [] })
                } else if(menu.customId === "shop_tile_9") {
                    await menu.deferUpdate();
                    let [ directory ] = menu.values;
                    ...
                    await collector.stop();
                    await menu.followUp({ embeds: [embed], components: [], files: [] })
                } else if(menu.customId === "shop_tile_10") {
                    await menu.deferUpdate();
                    let [ directory ] = menu.values;
                    ...
                    await collector.stop();
                    await menu.followUp({ embeds: [embed], components: [], files: [] })
                } else if(menu.customId === "shop_tile_11") {
                    await menu.deferUpdate();
                    let [ directory ] = menu.values;
                    ...
                    await collector.stop();
                    await menu.followUp({ embeds: [embed], components: [], files: [] })
                } else if(menu.customId === "shop_tile_12") {
                    await menu.deferUpdate();
                    let [ directory ] = menu.values;
                    ...
                    await collector.stop();
                    await menu.followUp({ embeds: [embed], components: [], files: [] })
                } else if(menu.customId === "shop_tile_13") {
                    await menu.deferUpdate();
                    let [ directory ] = menu.values;
                    ...
                    await collector.stop();
                    await menu.followUp({ embeds: [embed], components: [], files: [] })
                } else if(menu.customId === "shop_tile_14") {
                    await menu.deferUpdate();
                    let [ directory ] = menu.values;
                    ...
                    await collector.stop();
                    await menu.followUp({ embeds: [embed], components: [], files: [] })
                } else if(menu.customId === "shop_tile_15") {
                    await menu.deferUpdate();
                    let [ directory ] = menu.values;
                    ...
                    await collector.stop();
                    await menu.followUp({ embeds: [embed], components: [], files: [] })
                } else if(menu.customId === "shop_tile_16") {
                    await menu.deferUpdate();
                    let [ directory ] = menu.values;
                    ...
                    await collector.stop();
                    await menu.followUp({ embeds: [embed], components: [], files: [] })
                } else if(menu.customId === "shop_tile_17") {
                    await menu.deferUpdate();
                    let [ directory ] = menu.values;
                    ...
                    await collector.stop();
                    await menu.followUp({ embeds: [embed], components: [], files: [] })
                } else if(menu.customId === "shop_tile_18") {
                    await menu.deferUpdate();
                    let [ directory ] = menu.values;
