...
const { selectAnyomni_Upgradet_human } = require("./select_class/human/selectAnyomni_Upgradet_human.js");
const { selectAnyomni_Upgradet_sword } = require("./select_class/sword/selectAnyomni_Upgradet_sword.js");
const { selectAnyomni_Upgradet_warrior } = require("./select_class/warrior/selectAnyomni_Upgradet_warrior.js");
const { selectAnyomni_Upgradet_magic } = require("./select_class/magic/selectAnyomni_Upgradet_magic.js");

const shopAnyomniUpgrade = async (client, interaction, msg, item) => {
    ...
    collector.on('collect', async (menu) => {
        if (menu.isButton()) {
            ...
            if(menu.customId === "human_id") {
                ...
                selectAnyomni_Upgradet_human(client, interaction, msg, item);
            collector.stop();
            } else if (menu.customId === "sword_id") {
                await menu.deferUpdate();

                selectAnyomni_Upgradet_sword(client, interaction, msg, item);
            collector.stop();
            } else if (menu.customId === "warrior_id") {
                await menu.deferUpdate();

                selectAnyomni_Upgradet_warrior(client, interaction, msg, item);
            collector.stop();
            } else if (menu.customId === "magic_id") {
                await menu.deferUpdate();

                selectAnyomni_Upgradet_magic(client, interaction, msg, item);
            collector.stop();
            }
        }
    });
...
module.exports = { shopAnyomniUpgrade };